...
/** Location is outside the local-only Android 2.3 legacy MVP and fails explicitly. */
public abstract class LocationProvider {
    ...
    public static LocationProvider getInstance(Criteria criteria) throws LocationException {
        throw new LocationException("Location is unsupported on the Android 2.3 legacy build");
    }
